...
func TestParseMsg(t *testing.T) {
	...
	} else if got, want := s.RTPStat.PS, uint32(295); got != want {
		t.Errorf("[TestParseMsg] Error parsing msg.  s.RTPStat.PS: got %d, want %d.", got, want)
	}
}
